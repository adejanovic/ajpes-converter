...
def validate(result):
    ...
    if not result.company.registration_number and result.pdf_format not in ("UPR", "GDZADRUGE", "OCR", "OCR_SCAN", "POROCILO_GD", "VIZIJA", "ZAVOD_MEDLETNI", "AJPES_NATIVE_XLS", "URADNI", "OBRACUNI_MEDLETNI", "BS_IPI_AJPES", "AJPES_1COL"):
...
# ŠE NI TESTIRANO na resnični IPI datoteki tega formata (glej povzetek za nadaljevanje) -
# ko Aleksander naloži IPI datoteko, je treba z istim postopkom kot za BS (testni
# skript za štetje ujemanj/neujemanj) preveriti pokritost in dopolniti ta slovar.
